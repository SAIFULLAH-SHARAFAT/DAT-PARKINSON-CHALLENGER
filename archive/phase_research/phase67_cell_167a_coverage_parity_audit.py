...
PHASE67A_CONFIG = {
    ...
    # "package.module:function" taking a case index (0..CASE_COUNT-1) and
    # returning that case's recomputed 80^3 array, read from DAT_NIFTI_ROOT.
...
def cache_parity(state, config, rng):
    ...
    if not root.is_dir():
        ...
        return result
    result["nifti_root_resolved"] = bool(root.is_dir())
