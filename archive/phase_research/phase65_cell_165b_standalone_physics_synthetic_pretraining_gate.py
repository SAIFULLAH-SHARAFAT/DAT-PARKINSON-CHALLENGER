    ...
    PHASE65A_CONFIG = {
        **PHASE65A_CONFIG,
        ...
        "contract_file": str(phase65a_test_override.get(
            "contract_file", os.path.join(tempfile.gettempdir(), "phase65b_synthetic_contract.json")
        )),
        "checkpoint_directory": str(phase65a_test_override.get(
            "checkpoint_directory", os.path.join(tempfile.gettempdir(), "phase65b_private_checkpoint")
        )),
    }
