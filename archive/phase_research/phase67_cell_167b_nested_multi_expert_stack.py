...
def main():
    ...
    # Recorded AND enforced: a stack containing a vector whose partition
    # provenance is unverified cannot be a deployment candidate, only a
    # complementarity diagnostic.
    ineligible_experts = sorted(
        record["name"] for record in accepted_records
        if not record["deployment_eligible"]
    )
    ...
    core = {
        ...
        "ineligible_experts_in_stack": ineligible_experts,
        "interpretation": {
